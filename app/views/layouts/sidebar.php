  ...
  <div class="h-full flex flex-col">
    ...
    <nav class="mt-2 flex-1 px-2 space-y-1 text-sm">
      <?php if (Auth::check()): ?>
        ...
        <a href="<?= Security::e($publicJobsUrl) ?>" target="_blank" rel="noopener noreferrer" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
          ...
          <span>Link vagas públicas</span>
        </a>
        <a href="<?= $base ?>/admin/vagas" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <a href="<?= $base ?>/admin/candidaturas" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <a href="<?= $base ?>/admin/indicacoes" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <a href="<?= $base ?>/admin/pipeline" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <a href="<?= $base ?>/admin/beneficios" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <a href="<?= $base ?>/admin/usuarios" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
        ...
        <?php endif; ?>
        <a href="<?= $base ?>/admin/manual" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-200 hover:text-white transition-colors">
      ...
      <?php else: ?>
        ...
        <a href="<?= $base ?>/admin/login" class="flex items-center px-3 py-2 rounded hover:bg-ctgreen hover:bg-opacity-50 text-gray-300 hover:text-white transition-colors">
